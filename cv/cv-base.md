...
### Técnico de Manufactura — Qorvo Inc. | Mar 2022 – Dic 2025
Zona Franca Metropolitana, Heredia · Manufactura de semiconductores. Salida por cierre de operaciones de Qorvo en Costa Rica y traslado de la planta a Asia.
- Mantenimiento preventivo y correctivo de equipos de línea SMT: pick and place, hornos de reflow, probadores eléctricos con fixture y sistemas de visión.
- Diagnóstico y reparación de fallas en sistemas eléctricos, neumáticos, de vacío y aire comprimido.
- Monitoreo y optimización del rendimiento de equipos de prueba eléctrica mediante calibraciones y ajustes técnicos.
- Gestión de repuestos y solicitud de piezas mediante SAP.
- Participación en proyectos de mejora continua y optimización de procesos.
- Logro: reducción del 15% en el tiempo de inactividad de equipos de producción.
- Logro: mejora del yield de pruebas eléctricas mediante calibración y ajuste de fixtures, con menos rechazos por errores mecánicos y de test.
...
Área técnica de Intel, Heredia · Manufactura de semiconductores.
- Soporte técnico y operación de equipo de laboratorio en línea de manufactura de semiconductores.
...
- Sistema de monitoreo y registro de datos en operación continua 24/7, con alertas, detección de fallos de conexión y recuperación automática.
- Aplicación Android de cálculo y registro de rentabilidad, con base de datos local e interfaz de usuario.
- Análisis estadístico de datos operativos y validación de resultados con conjuntos de prueba independientes.

## FORMACIÓN ACADÉMICA

- Ingeniería Electromecánica — Universidad Fidélitas · En curso (35%)
- Técnico Medio en Electrónica Industrial — COVAO · 2017 – 2019

## COMPETENCIAS TÉCNICAS

- Líneas SMT: pick and place · hornos de reflow · probadores eléctricos con fixture · sistemas de visión
- Mantenimiento: preventivo · correctivo · diagnóstico de fallas · calibración
- Sistemas: eléctricos · neumáticos · vacío · aire comprimido
...
- Calidad y ambiente regulado: cuarto limpio · manufactura médica regulada
